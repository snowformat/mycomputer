<template>
  <div class="container-wrap">
    <!-- 顶部标题 -->
    <div class="top-title">
      <h2>蜻蜓FM x Wehotel 联合会员</h2>
      <span>一份价格 &nbsp; 双份收益</span>
    </div>
    <!-- 内容区域 -->
    <div class="main-area">
      <div class="left main-pic">
        <!-- <img src="../../static/images/Group42.png" alt=""> -->
      </div>
      <div class="left checkbox">
        ...
        <div>
          ...
          <!-- <button v-if="rechargeCheck" class=" recharge-btn recharge-btn-true">兑换</button>
          <button v-if="!rechargeCheck" class=" recharge-btn recharge-btn-error">兑换</button> -->
      </div>
    </div>
  </div>
</template>
<script>
import resultInfo from '../api/index.js'
export default {
  data () {
    return {
      // 兑换码的信息提示
